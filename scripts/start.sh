...
function print_help() {
  ...
  echo "It pulls git repositories, builds jars, builds docker images, starts containers, deletes old docker images and containers"
}
...
function init() {
    ...
    echo -e "\nStarter script total time: $TIMESTAMP"
}
